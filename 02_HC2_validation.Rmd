...
**Key Observations:**
- Under the null ($\lambda = 0$), $S_{\mathrm{Inf}}^{*}$ is centered near zero across all sample sizes.
- As heteroskedasticity increases, $S_{\mathrm{Inf}}^{*}$ shifts positive (robust SE > classic SE).
- The score increases with both $\lambda$ and $N$, confirming its behavior as a test statistic.
